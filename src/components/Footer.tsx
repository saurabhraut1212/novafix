...
export default function Footer() {
  return (
    <footer className="py-10 px-6 border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-700">
      <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
        
        {/* Branding */}
        <div className="text-center sm:text-left">
          <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100">NovaFix</h3>
        ...
        {/* Links */}
        <div className="flex flex-wrap justify-center gap-8 text-base text-gray-700 dark:text-gray-400 font-medium">
      ...
      {/* Bottom Line */}
      <div className="mt-8 text-center text-sm sm:text-base text-gray-600 dark:text-gray-500">
